...
If a cdoc has more than 6 source files, split it. Update manifest.md and any prompts referencing the old filename.
If a cdoc exceeds 70 lines after edits, split it. Update manifest.md and any prompts referencing the old filename.
